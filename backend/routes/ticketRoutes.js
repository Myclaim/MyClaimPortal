...
const { getTickets, getTicketById, createTicket, updateTicketStatus, updateEmployeeTicketStatus, assignTicket, addTicketComment, bulkUpdateTickets, escalateTicket, addTicketAttachment, updateTicketStages, updateTicketDetails, deleteTicket } = require('../controllers/ticketController');

router.route('/').get(protect, getTickets).post(protect, createTicket);
router.route('/bulk').patch(protect, admin, bulkUpdateTickets);
router.route('/:id').get(protect, getTicketById).patch(protect, admin, updateTicketDetails).delete(protect, admin, deleteTicket);
