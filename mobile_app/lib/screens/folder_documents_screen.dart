  ...
  Widget _buildDocumentTile(Map<String, dynamic> doc) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text(type.toString().toUpperCase(), style: TextStyle(color: context.textSecondaryColor, fontSize: 12.sp)),
        trailing: Icon(Icons.open_in_new_rounded, color: context.textSecondaryColor, size: 20.sp),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.folder_open_rounded, size: 80.sp, color: context.borderColor),
          SizedBox(height: 16.h),
          Text('Folder is empty', style: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.bold, color: Colors.white)),
          SizedBox(height: 8.h),
          Text('No documents found in this folder.', style: TextStyle(color: context.textSecondaryColor)),
        ],
      ),
    );
  }
